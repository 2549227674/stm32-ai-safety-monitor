...
| 11-B | 继电器 | 最简单的输出，验证 PCA9685 通道开关 + 默认 OFF | 已通过（KY-019 active high，默认 OFF，ALARM 动作） |
...
- [x] 11-B 继电器：默认 OFF（程序未运行不吸合）；KY-019 PCA9685 CH5 active high 可吸合/释放；ALARM 时动作，退出释放。
