...
> **[CLAUDE_CODE_TODO | MEASURE]** 实测 MG90 角度、稳定时间和 PWM 脉宽
> - 为何 GPT 给不了：沙箱无法连接 PCA9685 与舵机。
> - 期望产物/操作：先空载测 PWM，再接单个 MG90，记录 60/90/120 度对应脉宽和稳定时间。
> - 回填位置：docs/08 第 8.4；Task08
> - 验收：云台无明显抖动，抓拍时画面稳定。
