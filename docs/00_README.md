...
| 4 | `docs/03_硬件系统设计与供电安全_iMX6ULL_OPi5.md` | 硬件设计 |
| 5 | `docs/04_软件架构与模块划分_Linux边缘控制版.md` | 软件架构 |
| 6 | `docs/06_状态机与联动机制_Linux实现版.md` | 状态机 |
| 7 | `docs/07_端边HTTP_JSON_Contract.md` | API 契约权威 |
| 8 | `docs/09_OrangePi5_RKNN本地AI推理与解释方案.md` | AI 实现 |
| 9 | `docs/11_测试计划与风险矩阵_端边协同版.md` | 测试证据 |
| 10 | `docs/13_实训报告与答辩演示方案_迁移版.md` | 报告/PPT |
