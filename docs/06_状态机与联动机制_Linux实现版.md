...
OLED 每轮显示 `state / risk_score / soc_temp / 关键 sensors / actuator` 摘要。断网、断 AI、Flask 不可达时仍刷新。
...
详见 `CLAUDE_CODE_TASK_11_imx6ull_p1_oled_relay_fan_soctemp_pump.md`。
