...
/* Private defines -----------------------------------------------------------*/
#define DOOR_MAG_DO_Pin GPIO_PIN_4
...
#define FLAME_DO_Pin GPIO_PIN_12
#define FLAME_DO_GPIO_Port GPIOB
#define MQ2_DO_Pin GPIO_PIN_14
#define MQ2_DO_GPIO_Port GPIOB
#define PIR_DO_Pin GPIO_PIN_15
#define PIR_DO_GPIO_Port GPIOB
