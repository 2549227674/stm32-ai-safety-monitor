...
| Task03 GPIO/I2C/PWM/舵机 | 部分完成 | `tests/imx6ull/2026-06-06_*.md` | Task03-A GPIO 输入通过；Task03-B I2C/PCA9685 地址通过；Task03-C 空载 PWM 软件准备完成（波形实测跳过）；Task03-D MG90S 分时大幅动作（1100→1900us）通过；MOS 未完成。 |
