...
| 当前执行器 | 本地 Codex |
| 首要目标 | Task09 最终演示 / Task10 P0 真实化 / 报告与答辩材料，待用户决策 |
...
| 门磁 door | gpio118 读取真实开合 | 待验 | — | Task10-A |
| 火焰 flame | gpio119 读取真实触发 | 待验 | — | Task10-B |
| MQ-2 mq2 | gpio120 读取真实触发（需分压） | 待验 | — | Task10-C |
| PIR 真实触发 | gpio117 取得 raw=1 证据 | 待验 | — | Task10-D |
| 蜂鸣器 buzzer | gpio122 + 三极管真实驱动 | 待验 | — | Task10-E |
| RGB 状态色 | gpio121/123/124 真实驱动 | 待验 | — | Task10-E |
...
| Task10 P0 传感器/执行器真实化 | 待执行 | — | 门磁/火焰/MQ-2/PIR 真实 GPIO + 蜂鸣器/RGB 真实驱动；按 10-A→10-E 垂直切片逐个验证；不改 OPi5/AI，不改 Flask schema。 |
