...
| 总体阶段 | Task11-A/11-B/11-C 已通过；待执行 11-D 水泵 |
...
| Task11 P1 扩展 | 11-A/11-B/11-C 已通过 | `CLAUDE_CODE_TASK_11_imx6ull_p1_oled_relay_soctemp_pump.md`、CANONICAL 0.7 | 11-A OLED 已通过；11-B relay 已通过；11-C soc_temp 已通过；11-D pump water tank：待验 |
