...
| 总体阶段 | Task10-E 已完成：P0 输入/输出真实化主体验收（door 跳过，RGB-R 红灯待查硬件） |
...
| Task10 P0 传感器/执行器真实化 | 主体完成 | `tests/imx6ull/2026-06-07_p0_*.md` | 10-B 火焰通过、10-C MQ-2 通过、10-D PIR 沿用历史、10-E 蜂鸣器+RGB 通过；10-A 门磁跳过；RGB-R 红灯待查硬件。 |
