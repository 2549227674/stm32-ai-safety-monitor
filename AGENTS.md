...
| 最新迁移提交 | `c984e22 task04: V4L2 USB camera capture pass`；Task05-A 已完成并在本轮提交 |
| 总体阶段 | Task05-A 已完成：OPi5 AI mock 服务通过；真实 RKNN 尚未接入 |
| 新主线 | i.MX6ULL Pro + Orange Pi 5 + Flask |
| 旧主线 | STM32 + ESP32-CAM 归档为 legacy |
| 当前执行器 | 本地 Codex |
| 首要目标 | Task05-B RKNN demo 资产盘点 / 或 Task06 Flask 扩展，待用户决策 |
