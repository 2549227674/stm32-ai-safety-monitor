...
| 总体阶段 | Task10-E2 已完成；Task11 P1 扩展文档已入库，待执行 11-A OLED 首切片 |
...
| 10 | `CLAUDE_CODE_TASK_11_imx6ull_p1_oled_relay_fan_soctemp_pump.md` | P1 OLED/继电器/SoC温度/水泵 | OLED 状态屏 + PCA9685 CH5/CH6 负载 + SoC 温度热健康 + 隔离水箱；全部待验证 |
...
| Task11 P1 扩展 | 文档入库 / 待执行 | `CLAUDE_CODE_TASK_11_*.md`、CANONICAL 0.7 | 11-A OLED：待验；11-B relay：待验；11-C soc_temp：待验；11-D pump water tank：待验 |
