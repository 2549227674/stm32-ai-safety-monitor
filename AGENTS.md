...
| 当前执行器 | 本地 Codex |
| 首要目标 | Task03-A GPIO 输入验证准备已完成，等待用户选择安全输入源并贴回 0/1 变化输出 |
...
| GPIO 输入 | 门磁/PIR/火焰/按键至少一路 | 待用户实测（Task03-A 软件准备完成） | `tests/imx6ull/2026-06-06_gpio_input_probe.md` | Task03 |
