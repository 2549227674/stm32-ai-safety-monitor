...
| 总体阶段 | Task02 已完成：WSL SDK、SSH、hello 交叉编译与板端运行通过 |
| 新主线 | i.MX6ULL Pro + Orange Pi 5 + Flask |
| 旧主线 | STM32 + ESP32-CAM 归档为 legacy |
| 当前执行器 | 本地 Codex |
| 首要目标 | Task03-A GPIO 输入验证准备与 100ask 引脚参考已完成，外部输入等待上拉/稳定 DO 后补测 |
...
| GPIO 输入 | 门磁/PIR/火焰/按键至少一路 | 待补测（Task03-A 软件准备完成；缺少 10k 上拉/稳定 DO） | `tests/imx6ull/2026-06-06_gpio_input_probe.md`、`docs/reference/hardware/100ask_imx6ull_pinmap.md` | Task03 |
