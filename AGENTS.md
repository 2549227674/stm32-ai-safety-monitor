...
| Task11 P1 扩展 | 11-A/11-B 已通过 | `CLAUDE_CODE_TASK_11_imx6ull_p1_oled_relay_soctemp_pump.md`、CANONICAL 0.7 | 11-A OLED 已通过；11-B relay 已通过（PCA9685 CH5 active high，默认 OFF，ALARM 动作）；11-C soc_temp：待验；11-D pump water tank：待验 |
