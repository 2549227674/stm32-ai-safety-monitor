...
| 最新迁移提交 | `ab17f8b task07-b: add imx safetyd lite gpio degradation spool`；Task07-C 已完成并在本轮提交 |
| 总体阶段 | Task07-C 已完成：C 版 imx_safetyd once/loop/flush + GPIO + 降级/spool 通过 |
...
| 端边垂直切片 | i.MX→OPi5→Flask | Task07-C 已验证（C 版 imx_safetyd：真实 gpio117 空闲读取、FORCE_VERIFY 抓拍、OPi5 mock AI、Flask 上报、offline 降级、spool/flush、loop；PIR 未人工触发 raw=1） | `tests/integration/2026-06-07_imx_safetyd_c.md` | Task07-C |
