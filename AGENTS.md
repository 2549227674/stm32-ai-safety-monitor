...
| Task11 P1 扩展 | 11-A 已通过 | `CLAUDE_CODE_TASK_11_imx6ull_p1_oled_relay_soctemp_pump.md`、CANONICAL 0.7 | 11-A OLED 已通过（i2cdetect 0x3C，oled_test 刷屏，imx_safetyd loop 刷新）；11-B relay：待验；11-C soc_temp：待验；11-D pump water tank：待验 |
