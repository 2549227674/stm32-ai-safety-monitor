...
| Task12-I OPi5 Qwen3-VL 自启动 | 已通过 | `tests/opi5/2026-06-08_qwen3vl_autostart_real_ai.md` | systemd 自启动，默认 Qwen3-VL 真实 AI（非 mock），API 内嵌 worker 管理，重启后自动恢复，i.MX→OPi5 infer ~5s；mock 保留为手动回退；清理 OPi5 旧代理配置 |
