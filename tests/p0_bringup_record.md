...
| P0-05A | 继电器低压驱动 | 未开始 | PA6 / RELAY1_CTRL；继电器未到货，暂缓 |
| P0-05B | 风扇低压驱动 | 已完成 | PA7 / FAN_CTRL → L9110S INA；INB → GND；VCC → 5V；GND → 公共 GND；K2 风扇 ON，K4 风扇 OFF；蜂鸣器不误响，RGB 不乱亮，OLED 正常刷新；使用 L9110S 风扇驱动模块；测试完成后已拔掉 PA7 接线 |
| P0-05C | 水泵低压驱动 | 未开始 | PB8 / PUMP_CTRL；水泵未开始 |
